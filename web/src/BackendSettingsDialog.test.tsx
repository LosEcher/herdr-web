...
function settingsProps() {
  return {
    ...
    onBrowserNotificationsEnabled: vi.fn(),
    browserNotifyOnBlocked: true,
    onBrowserNotifyOnBlocked: vi.fn(),
    browserNotifyOnDone: true,
    onBrowserNotifyOnDone: vi.fn(),
    browserDocumentBadge: false,
    onBrowserDocumentBadge: vi.fn(),
    webPushAvailable: false,
    webPushEnabled: false,
    webPushBusy: false,
    webPushStatus: null,
    onWebPushEnabled: vi.fn(),
